<html lang="pt-br">
    <head>
        ...
        <title>RHWEB - Relatório Evento s-1270</title>
    </head>
    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="margin-top">
                <table class="margin-left margin-bottom margin-top">
                    <tr>
                        <td class="text-center name__title--evento text-bold">Evento s-1270 - Tomador de mão de obra - Trabalhador avulso não portuário</td>
                    </tr>
                </table>
            </div>
            ...
            <div  class="margin-top borderT">
                ...
                <table>
                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom text-bold">Produção</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom">R$ 
                            <?php
                                $producao = 0;
                    ...
                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom text-bold">DSR - Descanso Semanal Remunerado 18,18%</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom">R$ 
                            <?php
                                $dsr = 0;
                                foreach ($relatorio as $key => $relatorios) {
                    ...
                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom text-bold">Férias 11,12%</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom">R$ 
                        <?php
                                $feria = 0;
                                foreach ($relatorio as $key => $relatorios) {
                    ...
                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom destaque text-bold">Total (Produção/DSR/Férias)</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom destaque">R$ {{number_format((float)$total, 2, ',', '.')}}</td>
                    </tr>

                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom text-bold">13° Salário 8,34%</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom">R$ 
                            <?php
                                $salario13 = 0;
                                foreach ($relatorio as $key => $relatorios) {
                    ...
                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom text-bold">Valor bruto da Folha de Pagamento - FGTS</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom">R$ 
                            <?php
                                $fgts = 0;
                                foreach ($relatorio as $key => $relatorios) {
                                    $fgts += $relatorios->bifgtsmes;
                                }
                            ?>
                            {{number_format((float)$fgts, 2, ',', '.')}}
                        </td>
                    </tr>

                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom text-bold">Contribuição INSS Total dos Trabalhadores</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom">R$ 
                        <?php
                                $in = 0;
                                foreach ($relatorio as $key => $relatorios) {
                    ...
                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao border-bottom text-bold">INSS sobre 13º Salário</td>
                        <td class="padding-left-texto medium__font text-center valor border-bottom">R$ 
                        <?php
                                $insalario13 = 0;
                                foreach ($relatorio as $key => $relatorios) {
                    ...
                    <tr>
                        <td class="padding-left-texto medium__font border-right descricao text-bold">INSS sobre (Produção/DSR/Férias)</td>
