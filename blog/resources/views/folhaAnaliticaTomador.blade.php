          ...
          <body>
            <div id="header">
                ...
                <table class="margin-top">
                  <tr>
                      <td class="border-left border-right border-top border-bottom uppercase name__title text-center text-bold destaqueDark">{{$folhas->tsnome}}</td>
                  </tr>
              </table>
                <table>
                    <tr>
            ...
            <div id="content">
              ...
              <table>
                ...
                <tr>
                    ...
                    <td class="border-top border-bottom border-left text-bold small__font text-center decimo">{{$resumo_geral['C. Sindical']?number_format((float)$resumo_geral['Adiantamento'], 2, ',', '.'):''}}</td>
