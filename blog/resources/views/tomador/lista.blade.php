                        ...
                        <table class="table">
                            ...
                            <tbody class="table__body">
                                ...
                                <tr class="tr__body">
                                    ...
                                    <td class="td__body text-nowrap col" style="width:60px;">
                                        <a class="btn__evento btn modal-botao btn__padrao--evento" data-id="{{base64_encode($tomador->id)}}" href="{{route('esocial.tomador',base64_encode($tomador->id))}}" class=""><i class="icon__color fas fa-file-invoice"></i></a>
                                    </td>
                                    <td class="td__body text-nowrap col" style="width:60px;">
