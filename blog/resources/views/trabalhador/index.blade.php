...
<div class="container">
  ...
  <form class="row g-3" id="form" action="{{ route('trabalhador.store') }}" enctype="multipart/form-data" method="POST">
        ...
        <div class="col-md-6">
              <label for="nome__completo" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> Nome Completo
        ...
        <div class="col-md-3">
              <label for="cpf" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> CPF</label>
        ...
        <div class="col-md-3">
              <label for="pis" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> PIS</label>
        ...
        <div class="col-md-3">
              <label for="sexo" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> Sexo</label>
        ...
        <div class="col-md-6">
          <label for="estado__civil" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> Estado Civil</label>
        ...
        <div class="col-md-6">
          <label for="raca" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> Raça</label>
        ...
        <div class="col-md-6">
          <label for="grau__instrucao" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> Grau de Instrução</label>
        ...
        <div class="col-md-6">
              <label for="data_nascimento" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> Data de Nascimento</label>
        ...
        <div class="col-md-6">
              <label for="pais__nascimento" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> País de Nascimento</label>
        ...
        <div class="col-md-6">
              <label for="pais__nacionalidade" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> País de Nacionalidade</label>
        ...
        <div class="col-md-6">
              <label for="nome__mae" class="form-label"><i class="fa-sm required fas fa-asterisk"></i> Nome da Mãe</label>
        ...
        <div class="container text-center  fs-4 fw-bold mt-4 mb-3"></div>
                ...
                <div class="accordion-item item__acorddion">
                    ...
                    <h2 class="accordion-header accoordion__header" id="contrato">
                          <button class="accordion-button button__accoordion collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#localResidencia" aria-expanded="false" aria-controls="localResidencia">
                            <i class="me-1 fa-sm required fas fa-asterisk"></i>Local de Residência <i class="ms-1 fad fa-map-marked-alt"></i>
                          </button>
                    </h2>
                    ...
                    <div id="localResidencia" class="accordion-collapse collapse" aria-labelledby="contrato" data-bs-parent="#accordionFlushExample">
                        ...
                        <div class="accordion-body row">
                            ...
                            <div class="col-md-3 mt-2">
                                  <label for="cep" class="form-label letter__color"><i class="fa-sm required fas fa-asterisk"></i> CEP</label>
                            ...
                            <div class="col-md-7 mt-2">
                                  <label for="logradouro" class="form-label letter__color"><i class="fa-sm required fas fa-asterisk"></i> Rua</label>
                            ...
                            <div class="col-md-2 mt-2">
                                  <label for="numero" class="form-label letter__color"><i class="fa-sm required fas fa-asterisk"></i> Número</label>
                            ...
                            <div class="col-md-4 mt-2">
                                  <label for="tipoconstrucao" class="form-label letter__color"><i class="fa-sm required fas fa-asterisk"></i> Tipo</label>
                            ...
                            <div class="col-md-8 mt-2">
                                  <label for="bairro" class="form-label letter__color"><i class="fa-sm required fas fa-asterisk"></i> Bairro</label>
                            ...
                            <div class="col-md-8 mt-2">
                                  <label for="localidade" class="form-label letter__color"><i class="fa-sm required fas fa-asterisk"></i> Municipio</label>
                            ...
                            <div class="col-md-4 mt-2">
                                  <label for="uf" class="form-label letter__color"><i class="fa-sm required fas fa-asterisk"></i> UF</label>
        ...
        <div class="container text-center mt-4 mb-3 fs-4 fw-bold"></div>
