                        ...
                        @foreach ($depedentes as $key=>$depedente)
                            <tr class="tr__body">               
                                ...
                                <td class="td__body text-nowrap col" style="width:60px;">
                                    ...
                                    <button class="btn button__excluir modal-botao" data-bs-toggle="modal" data-bs-target="#deletarDepedente{{$key}}">
...
<section class="delete__tabela--trabalhador">
    <div class="modal fade" id="deletarDepedente{{$key}}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
