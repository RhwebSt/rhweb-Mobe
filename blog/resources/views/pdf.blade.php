    ...
    @endif
      ...
      <tbody>
          @foreach($trabalhadors as $trabalhador)
            <tr class="bottom">
                <td class="matricula small__font border-right border-left border-bottom">{{$trabalhador->tsmatricula}}</td>
                <td class="nome small__font border-right border-left border-bottom">{{$trabalhador->tsnome}}</td>
                <td class="cpf small__font border-right border-left border-bottom">{{$trabalhador->tscpf}}</td>
                <td class="adm small__font border-right border-left border-bottom">
                ...
                <td class="nasc small__font border-right border-left border-bottom">
                ...
                <td class="pis small__font border-right border-left border-bottom">{{$trabalhador->dspis}}</td>
                <td class="situacao small__font border-right border-left border-bottom">{{$trabalhador->cssituacao}}</td>
            </tr>
        @endforeach
      </tbody>
    </table>
