    ...
    <h2 class="">MOBE PRESTADORA DE SERVIÇOS LTDA</h2>
      ...
      <table>
        <thead>
          <tr class="">
            ...
            <th class="cpf">CPF</th>
            <th class="adm">Data ADM</th>
            <th class="nasc">Data Nasc</th>
            <th class="pis">PIS</th>
      ...
      <tbody>
          @foreach($trabalhadors as $trabalhador)
            <tr>
                <td class="matricula">{{$trabalhador->tsmatricula}}</td>
                <td class="nome">{{$trabalhador->tsnome}}</td>
                <td class="cpf">{{$trabalhador->tscpf}}</td>
                <td class="adm">{{$trabalhador->csadmissao}}</td>
                <td class="nasc">{{$trabalhador->nsnascimento}}</td>
