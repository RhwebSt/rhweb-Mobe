...
<html lang="pt-br">
    <head>
        ...
        <title>RHWEB - tabela Gerador de Acesso</title>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
        <link rel="stylesheet" href="./css/admin/dashboard.css">
        <link rel="stylesheet" href="./css/admin/cadastroEmpresa/cadastroEmpresa.css">
    ...
    <body>
        ...
        <div class="container">
            ...
            <section class="section__btn--new-empresa">
                <div class="">
                    <button type="button" class="button__new--empresa btn"><i class="fad fa-arrow-left"></i> Voltar</button>
                </div>
            </section>
            {{-- final do botao novo --}}
                ...
                <div class="table-responsive-xxl">
                    <table class="table">
                        ...
                        <thead class="table__header">
                            ...
                            <tr class="tr__header">
                                <th class="th__header text-nowrap" style="width:50px">Usuario</th>
                                <th class="th__header text-nowrap">Senha</th>
                                <th class="th__header text-nowrap">Email</th>
                                <th class="th__header text-nowrap">Link</th>
                                <th class="th__header text-nowrap" style="width:80px">Copiar</th>
                            </tr>
                        ...
                        <tbody class="table__body">
                            ...
                            <tr class="tr__body">
                                ...
                                <td class="td__body text-nowrap col"  style="width:50px">300</td>
                                <td class="td__body text-nowrap col"  data-bs-toggle="tooltip" data-bs-placement="top" title="Eliel" style="max-width: 30ch; overflow: hidden; text-overflow: ellipsis;">S#DDDSD</td>
                                <td class="td__body text-nowrap col"  data-bs-toggle="tooltip" data-bs-placement="top" title="email@email.com" style="max-width: 30ch; overflow: hidden; text-overflow: ellipsis;">email@email.com</td>
                                <td class="td__body text-nowrap col"  data-bs-toggle="tooltip" data-bs-placement="top" title="link" style="max-width: 30ch; overflow: hidden; text-overflow: ellipsis;"><input class="td__body text-nowrap col" style="border: none; text-align: center; background-color: transparent;" id="link" value="teste" readonly></td>
                                <td class="td__body text-nowrap col"  style="width:80px">
                                
                                    <button id="iconCopy" type="button" class="button__new--empresa btn"><i class="fad fa-copy"></i></button>
    ...
    <script>
         ...
         iconCopy.addEventListener('click', function(){
            console.log("clicou");
            var content = document.querySelector("#link");
            content.select();
            document.execCommand('copy');

        })
    </script>
    {{-- <script src="\js\cadastroUsuarioLogin.js"></script> --}}
