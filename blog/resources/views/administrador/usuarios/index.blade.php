                ...
                <form class="row g-3 form__bg" id="form" action="{{route('user.store')}}" enctype="multipart/form-data" method="Post">
                    ...
                    <div class="d-flex justify-content-center align-items-center flex-column div__form--gerador">
                        ...
                        <div class="col-md-8 mt-3 d-flex justify-content-start mb-3">
                            <buttom class="btn btn__voltar-gerador align-self-start mt-2 mb-2"><i class="fad fa-arrow-left"></i> Voltar</buttom>
                        </div>
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            <input type="text" class="form-control input fw-bold text-dark @error('name') is-invalid @enderror" name="name" value="{{old('name')}}" id="usuario" readonly>
                            @error('name')
                        ...
                        <div class="col-12 col-md-8 mt-2">
                            ...
                            <input type="text" class="form-control input fw-bold text-dark @error('senha') is-invalid @enderror" name="senha" value="{{old('senha')}}" id="codigo" readonly>
                            @error('senha')
                            <span class="">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-md-8 mt-2">
                            ...
                            <input type="email" class="form-control input fw-bold @error('email') is-invalid @enderror text-dark" name="email" value="{{old('email')}}" id="email">
                            @error('email')
                            <span class="">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 col-md-8 mt-3">
                            ...
                            <input type="link" class="form-control input fw-bold text-dark" name="link" value="" id="link">
                            <span class=""></span>
                        </div>
