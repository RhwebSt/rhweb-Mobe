...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" href="./css/admin/inss/inss.css">
    ...
    <body>
        ...
        <div class="container">
            ...
            <section class="section__button--inss">
                <div class="btn d-grid gap-1 mt-5 mx-auto d-md-block d-flex flex-wrap" role="button" aria-label="Basic example">
                    ...
                    <button type="submit" id="incluir" class="btn button__sair--inss" ><i class="fad fa-sign-out"></i> Sair</button>
                </div>
            </section>
    ...
    <script src="\js\inss\inss.js"></script>
