            ...
            <form class=" row g-3" action="" method="Post">
                ...
                <div class="d-flex justify-content-center flex-column align-items-center div__form--msg-email">
                    ...
                    <div class="mb-3 col-12 col-md-6">
                        ...
                        <input type="text" class="form-control" id="titulo__msg-email" value="{{ old('titulo__msg-email')}}" name="titulo__msg-email" placeholder="Titulo do Email" maxlength="20">
                    ...
                    <div class="mb-3 col-12 col-md-6">
                        ...
                        <textarea class="form-control" id="descricao__msg-email" rows="3" maxlength="255"></textarea>
                    </div>
