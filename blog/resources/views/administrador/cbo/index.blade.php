        ...
        <div class="container">
            ...
            <section class="section__botao--voltar--cbo">
                <div class="btn d-grid gap-1 mt-5 mx-auto d-md-block d-flex flex-wrap" role="group" aria-label="Basic example">
                    <a href="{{route('administrador')}}" class="btn button__voltar--cbo"><i class="fad fa-long-arrow-left"></i> Voltar</a>
                        ...
                        <tbody class="table__body">
                            ...
                            @foreach($lista as $listas)
                                <tr class="tr__body">
                                    ...
                                    <td class="td__body text-nowrap col" data-bs-toggle="tooltip" data-bs-placement="top" title="{{$listas->csdescricao}}" style="max-width: 20ch !important; overflow: hidden; text-overflow: ellipsis;">{{$listas->csdescricao}}</td>
