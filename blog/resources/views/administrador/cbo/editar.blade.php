                ...
                <input type="hidden" id="method" name="_method" value="PUT">
                    <div class="d-flex justify-content-center flex-column align-items-center div__form--cbo">
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('codigo__cbo') is-invalid @enderror" value="{{$editar->cscodigo}}" id="codigo__cbo" name="codigo__cbo" placeholder="código" maxlength="5">
                            @error('codigo__cbo')
                        ...
                        <div class="mb-3 col-12 col-md-6">
                            ...
                            <input type="text" class="form-control @error('descricao__cbo') is-invalid @enderror" value="{{$editar->csdescricao}}" id="descricao__cbo" name="descricao__cbo" placeholder="descrição" maxlength="60">
