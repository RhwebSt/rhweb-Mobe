...
@section('titulo','Editar cadastro de usuário - Rhweb')
@section('conteine')
<div class="container">
    @if(session('success'))
            <script>
    ...
    <form class="row g-3 mt-1 mb-3" id="form" action="{{ route('empresa.update',$empresa->id) }}" method="POST" action="">
        ...
        <div class="row">
            <div class="btn mt-3 form-control" role="button" aria-label="Basic example">
                ...
                <button type="submit" id="atualizar" class="btn botao">
                ...
                <a class="btn botao" href="{{route('listaempresa.create')}}" role="button"><i class="fad fa-sign-out-alt"></i> Sair</a>
            </div>
        </div>
        ...
        <div>
            ...
            <div>
                <div class="col-md-5 mb-3">
                    <img class="trabfoto" id="trabfoto" src="{{$empresa->esfoto}}" alt="logo do usuario">
                </div>
            ...
            <div>
                <div class="mb-4 col-md-4 inputfoto">
                    ...
                    <input type="hidden" name="foto" id="foto" value="{{$empresa->esfoto}}">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('escnpj') is-invalid @enderror fw-bold" value="{{$empresa->escnpj}}" name="escnpj" id="cnpj_mf">
            @error('escnpj')
        ...
        <div class="col-md-8">
            ...
            <input type="text" class="form-control @error('esnome') is-invalid @enderror fw-bold" value="{{$empresa->esnome}}" name="esnome" id="nome">
            @error('esnome')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-3">
            ...
            <input type="date" class="form-control fw-bold @error('dataregistro') is-invalid @enderror fw-bold" value="{{$empresa->esdataregitro}}" name="dataregistro" id="dataregistro">
            @error('dataregistro')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-3">
            ...
            <input type="text" class="form-control @error('cep') is-invalid @enderror fw-bold" maxlength="16" value="{{$empresa->escep}}" name="cep" id="cep">
            @error('cep')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control  @error('logradouro') is-invalid @enderror fw-bold" maxlength="50" value="{{$empresa->eslogradouro}}" name="logradouro" id="logradouro">
            @error('logradouro')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('numero') is-invalid @enderror fw-bold" maxlength="10" value="{{$empresa->esnum}}" name="numero" id="numero">
            @error('numero')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-3">
            ...
            <select name="complemento__endereco" id="complemento__endereco" class="form-select fw-bold">
                <?php
                $tipo = ['Casa', 'Apartamento', 'Empresa'];
                ?>
                @foreach($tipo as $tipos)
                @if($empresa->escomplemento === $tipos)
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control @error('bairro') is-invalid @enderror fw-bold" maxlength="40" value="{{$empresa->esbairro}}" name="bairro" id="bairro">
            @error('bairro')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control @error('localidade') is-invalid @enderror fw-bold" maxlength="30" value="{{$empresa->esmunicipio}}" name="localidade" id="localidade">
            @error('localidade')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-3">
            ...
            <input type="text" class="form-control @error('uf') is-invalid @enderror fw-bold" maxlength="2" value="{{$empresa->esuf}}" name="uf" id="uf">
            @error('uf')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('responsave') is-invalid @enderror fw-bold" value="{{$empresa->esresponsavel}}" name="responsave" id="responsave">
            @error('responsave')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control  fw-bold" value="{{$empresa->escpf}}" name="cpf" id="cpf">
            @error('cpf')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="email" class="form-control fw-bold @error('email') is-invalid @enderror fw-bold" value="{{$empresa->esemail}}" name="email" id="email">
            @error('email')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-md-4">
            ...
            <input type="text" class="form-control fw-bold @error('seguro') is-invalid @enderror fw-bold" value="{{$empresa->esseguro}}" name="seguro" id="seguro">
            @error('seguro')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('cnae__codigo') is-invalid @enderror fw-bold" value="{{$empresa->escnae}}" name="cnae__codigo" id="cnae__codigo">
            @error('cnae__codigo')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('cod__municipio') is-invalid @enderror fw-bold" value="{{$empresa->escodigomunicipio}}" name="cod__municipio" id="cod__municipio">
        ...
        <div class="col-md-4">
            ...
            <select id="sincalizado" name="sincalizado" class="form-select fw-bold">
                @if($empresa->essindicalizado === '1-Sim')
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('contribuicao__sindicato') is-invalid @enderror fw-bold" value="{{$empresa->escondicaosindicato}}" name="contribuicao__sindicato" id="contribuicao__sindicato">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control @error('telefone') is-invalid @enderror fw-bold" value="{{$empresa->estelefone}}" name="telefone" id="telefone">
            @error('telefone')
            <span class="text-danger">{{ $message }}</span>
            @enderror
        </div>
        ...
        <input type="hidden" name="endereco" id="endereco" value="{{$empresa->eiid}}">

        <input type="hidden" name="bancario" id="bancario" value="">
</div>
</form>
