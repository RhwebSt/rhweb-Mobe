                    ...
                    <tbody style="background-color: #081049; color: white;">
                        ...
                        <tr class="bodyTabela">
                            ...
                            <td class="col text-center border-bottom text-capitalize text-nowrap" style="width: 300px;">
                                <button type="button" class="btn text-white" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$empresa->esnome}}" style="max-width: 30ch; overflow: hidden; text-overflow: ellipsis;">
                                    <a>{{$empresa->esnome}}</a>
                                </button>
                            </td>
                            ...
                            <td class="col text-center border-bottom text-capitalize text-nowrap " style="width:120px">
                                <button type="button" class="btn text-white" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$empresa->esresponsavel}}" style="max-width: 30ch; overflow: hidden; text-overflow: ellipsis;">
                                    <a>{{$empresa->esresponsavel}}</a>
                                </button>
                            </td>

                            <td class="col text-center border-bottom text-nowrap" style="width:60px;">
                                <button type="button" class="btn text-white" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{$empresa->estelefone}}" style="max-width: 30ch; overflow: hidden; text-overflow: ellipsis;">
                                    <a>{{$empresa->estelefone}}</a>
                                </button>
                            </td>
                            <td class="col text-center border-bottom text-nowrap" style="width:60px;">
                                <button class="btn">
                                    <a class="btn__padrao--editar modal-botao" href="{{route('empresa.edit',$empresa->id)}}" class=""><i style="color: white;" class="fas fa-pen"></i></a>
                                </button>
                            </td>
                            <td class="col text-center border-bottom text-nowrap" style="width:60px;">
                                ...
                                <ul class="pagination">
                                    ...
                                    @for ($i = 1; $i <= $empresas->lastPage(); $i++)
                                        <li class="page-item {{ ($empresas->currentPage() == $i) ? ' active' : ''     }}">
                                            <a class="page-link modal-botao" href="{{ $empresas->url($i) }}">{{ $i }}</a>
                                        </li>
                                        @endfor
