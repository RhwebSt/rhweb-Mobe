            ...
            $( ".pesquisa" ).keyup(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        console.log(data);
                        if (data.trabalhador) {
                            $('#form').attr('action', "{{ url('usuariotrabalhador')}}/"+data.trabalhador);
                            $('#formdelete').attr('action',"{{ url('usuariotrabalhador')}}/"+data.trabalhador)
                        ...
                        $('#contribuicao__sindicato').val(data.esbairro)
