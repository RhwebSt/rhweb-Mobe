...
<body>
    ...
    <table>
        ...
        @foreach($recibo->valorcalculo as $valorcalculo)
                <tr>
                    ...
                    <td class="small__font border-left text-center vencimentos border-bottom">
    ...
    <table>
        ...
        <tr>
            ...
            <td class="small__font border-left text-bold total__vencimentos text-center destaqueDark border-top border-bottom medium__font">Valor Líquido</td>
