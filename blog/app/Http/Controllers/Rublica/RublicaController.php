...
class RublicaController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('rublica.index')->withInput()->withErrors(['false'=>'Não foi possível atualizar.']);
        }
    }
