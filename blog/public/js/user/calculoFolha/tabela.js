$(document).ready(function(){
            ...
            Swal.fire({
                ...
                if (event) {
                    ...
                    if (event.name.includes(nome) === false) {
                        ...
                        gerarxml_folhar(myFormData,id,nome)
                    }  
                }
                return false;
                }
    ...
    function gerarxml_folhar(dados,trabalhador,nome){
        ...
        $.ajax({
            ...
            success: function(retorno){
                ...
                cadastra_folhar(retorno.data,trabalhador,nome)
    ...
    function cadastra_folhar(dados,id,nome) {
        $.ajax({
